...
description: X-Forwarded-For, X-Real-IP, True-Client-IP, X-Forwarded-Host, Host header injection, virtual-host confusion, and RFC 7239 Forwarded consistency.
---
...
| `headertrust.host_header_injection` | Host Header Value Trusted | 5.3 | [CWE-350](https://cwe.mitre.org/data/definitions/350.html) | API8:2023 |
| `headertrust.vhost_confusion` | Virtual-Host Confusion via Crafted Host Header | 6.5 | [CWE-441](https://cwe.mitre.org/data/definitions/441.html) | API8:2023 |
...
| `headertrust.acl_bypass` | IP-Based Access Control Bypassed via Spoofed Client-IP Header | 8.7 | [CWE-290](https://cwe.mitre.org/data/definitions/290.html) | API5:2023 |
